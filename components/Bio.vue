    ...
    <div class="timeline-side">
      ...
      <div class="timeline-wrapper" :class="{ mobile: isMobile }">
        ...
        >
          ...
          >
            <div class="timeline-content">
              <h3 class="text-h6 font-bold mb-1">{{ item.title }}</h3>
              <div class="text-body-2 text-grey-darken-1">{{ item.date }}</div>
        ...
        <div v-if="isMobile" class="timeline-mobile-placeholder text-center mt-4">
          <p class="text-body-2">Swipe or scroll for timeline content.</p>
        </div>
      </div>
    </div>
  </div>
      ...
      highlightedItems: [
        {
          ...
          title: 'GrantPneu',
          date: '2025',
          text: 'Created my first project for client grantpneu.cz',
        },
        {
          color: '#FF81C1',
          icon: 'mdi-teach',
